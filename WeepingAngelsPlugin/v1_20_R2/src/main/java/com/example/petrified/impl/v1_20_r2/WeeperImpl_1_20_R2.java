package com.example.petrified.impl.v1_20_r2;
...
public class WeeperImpl_1_20_R2 implements WeeperAPI {
    @Override
    public String getVersionId() { return "v1_20_R2"; }
    @Override
    ...
    @Override
    public boolean isCompatible() { return org.bukkit.Bukkit.getServer().getMinecraftVersion().startsWith("1.20.4"); }
    @Override
